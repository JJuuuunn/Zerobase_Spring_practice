...
public class ApiBoardController {
    ...
    @PutMapping("/api/board/type/{id}/hits")
    ...
    @PutMapping("/api/board/type/{id}/like")
    ...
    @PutMapping("/api/board/type/{id}/unlike")
    ...
    @PutMapping("/api/board/type/{id}/badreport")
    public ResponseEntity<?> boardBadReport(@PathVariable Long id, @RequestHeader("F-TOKEN") String token
